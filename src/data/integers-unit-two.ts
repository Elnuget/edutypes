...
export const integersUnitTwoLessons: UnitLesson[] = [
  {
    ...
    exercises: [
      ...
      {
        id: 'ne-u2-c3-e1',
        title: 'Ejercicio 5: problema de videojuego',
        instructions: [
          'En un videojuego, Ana pierde `6`, pierde `3`, pierde `2`, luego gana `8` y gana `1` punto.',
      ...
      {
        id: 'ne-u2-c3-e2',
        title: 'Ejercicio 6: problema de alpinista',
        instructions: [
          'Un alpinista baja `8` m, sube `12` m, baja `3` m, sube `9` m, baja `1` m, baja `15` m y sube `7` m.',
          'Escribe solo el [[cambio final]] de altura.',
        ],
        placeholder: '',
        minLength: 1,
        checks: [],
