...
export const integersUnitOneLessons: UnitLesson[] = [
  {
    ...
    exercises: [
      ...
      {
        id: 'ne-u1-c3-e1',
        title: 'Ejercicio 5: problema de ascenso',
        instructions: [
          'Un dron sube `125` metros y despues sube `63` metros mas.',
          'Escribe solo el [[cambio total]] de altura.',
        ],
        placeholder: '',
        minLength: 3,
        checks: [],
        expectedAnswer: { kind: 'integer', value: 188 },
      },
      {
        id: 'ne-u1-c3-e2',
        title: 'Ejercicio 6: problema de penalizaciones',
        instructions: [
          'En un torneo un equipo recibe penalizaciones de `-120`, `-80` y `-50` puntos.',
          'Escribe solo el [[puntaje total]] que producen esas tres penalizaciones.',
        ],
        placeholder: '',
        minLength: 4,
        checks: [],
        expectedAnswer: { kind: 'integer', value: -250 },
      },
    ],
  },
];